...
class getAllAsianCountryDetailsServise {
    
  var client = http.Client();
  
  
  Future<List<CountryDetailsResponse>> getAllAsianContryDetails() async {
    ...
    var response = await client.get(
      ...
      Iterable<CountryDetailsResponse> europiancountries = countries.where((e) => e.continents.contains(Continent.ASIA));
