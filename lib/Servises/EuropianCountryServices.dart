...
class getAllEuropianCountryDetailsService {
    
  var client = http.Client();
  
  
  Future<List<CountryDetailsResponse>> getAllEuropianCountryDetails() async {
    ...
    var response = await client.get(
      ...
      Iterable<CountryDetailsResponse> europiancountries = countries.where((e) => e.continents.contains(Continent.EUROPE));
