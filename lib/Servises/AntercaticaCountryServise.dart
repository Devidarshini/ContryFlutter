...
class getAllAntarcticaDetailsServise {
    
  var client = http.Client();
  
  
  Future<List<CountryDetailsResponse>> getAllAntarcticaCountryDetails() async {
    ...
    var response = await client.get(
      ...
      Iterable<CountryDetailsResponse> europiancountries = countries.where((e) => e.continents.contains(Continent.ANTARCTICA));
