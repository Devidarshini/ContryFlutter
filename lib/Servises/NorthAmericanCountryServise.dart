...
class getAllNorthAmericanCountryDetailsServise {
    
  var client = http.Client();
  
  
  Future<List<CountryDetailsResponse>> getAllNorthAmericanContryDetails() async {
    ...
    var response = await client.get(
      ...
      Iterable<CountryDetailsResponse> europiancountries = countries.where((e) => e.continents.contains(Continent.NORTH_AMERICA));
