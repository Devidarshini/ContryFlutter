...
class getSouthAmericanCountries{
    
  var client = http.Client();
  
  
  Future<List<CountryDetailsResponse>> getSouthAmericanContryDetails() async {
    ...
    var response = await client.get(
      ...
      Iterable<CountryDetailsResponse> europiancountries = countries.where((e) => e.continents.contains(Continent.SOUTH_AMERICA));
