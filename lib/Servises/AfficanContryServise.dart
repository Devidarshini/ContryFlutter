...
class getAllAfricanCountryDetailsServise {
    
  var client = http.Client();
  
  
  Future<List<CountryDetailsResponse>> getAllAfricanContryDetails() async {
    ...
    var response = await client.get(
      ...
      Iterable<CountryDetailsResponse> europiancountries = countries.where((e) => e.continents.contains(Continent.AFRICA));
